...
public DesEncrypter(String passPhrase, String ALG) {
		...
		try {
			...
			*/
			 ...
			 */
    			...
    			DES.encrypt(new FileInputStream("cleartext.txt"), new FileOutputStream("DESciphertext"));
    			DES.decrypt(new FileInputStream("DESciphertext"), new FileOutputStream("DEScleartext.txt"));

    			DesEncrypter TDES = new DesEncrypter("test passphrase", "PBEWithMD5AndTripleDES" );
    			TDES.encrypt(new FileInputStream("cleartext.txt"), new FileOutputStream("TDESciphertext"));
    			TDES.decrypt(new FileInputStream("TDESciphertext"), new FileOutputStream("TDEScleartext.txt"));
		} 
