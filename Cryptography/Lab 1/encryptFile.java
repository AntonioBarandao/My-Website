...
public class encryptFile {
	...
	encryptFile(String passPhrase, String ALG) {
	...
	public static void main(String [] args) {
		...
		try{
			...
			if(args.length !=3){
				...
				System.out.println("java encryptFile <filename> <DES|3DES> <password>");
				return;
			}
			...
			// Convert user input into Java algorithm names
			String javaAlgorithm;
			
			if (algorithm.equalsIgnoreCase("DES")) {
            javaAlgorithm = "PBEWithMD5AndDES";
		    }
			else if (algorithm.equalsIgnoreCase("3DES")) {
			javaAlgorithm = "PBEWithMD5AndTripleDES";
		    }
		    else {
			...
			//Create encryptor
            DesEncrypter enc = new DesEncrypter(password, javaAlgorithm);
